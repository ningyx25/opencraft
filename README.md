...
https://github.com/ningyx25/opencraft/releases/download/v1.0.0-demo/demo.mp4
...
- 召唤后停留在原地，只响应显式指令（`player_goto` 移动、`teleport_to_player` 瞬移到主人身边）。
...
3. 点底部"用本方块召唤助手"，助手以玩家 bot 形态进服，停在方块原地待命。
